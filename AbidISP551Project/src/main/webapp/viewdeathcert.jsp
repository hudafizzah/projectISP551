        ...
        <div class="nav">
              ...
              <div class="nav-header">
               ...
               <div class="nav-links">
                ...
                <a href ="ListClaimController">BACK</a>
                <a></a>
                <a></a>
              </div>
        </div>
  
	<h3 style="text-align:center;">Payment ID: <c:out value="${c.applicationid}"/></h3> <br>
	<iframe src="deathcertificateimg/<c:out value="${c.deathcertificate}"/>" width="75%" height="1500px"></iframe>
